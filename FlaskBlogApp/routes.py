...
def search():
    print('sss')
    keyword = request.query.get_or_404('search')
    data = Article.query.msearch(keyword,fields=['article_title', 'article_body'])
    return render_template("article_title.html",title='Searching..' + keyword, article=data)
